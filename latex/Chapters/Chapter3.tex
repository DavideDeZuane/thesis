...
\begin{itemize}
    \item \textit{Tempo Complessivo} per stabilire la SA tra i due, il tempo di elabora\-zione del singolo algoritmo non ci interessa poichè ampiamente descritte
...
\begin{table}[h!] 
    ...
    \begin{tabular}{clcccc} 
        ...
        \multirow{3}{*}{C3} & \texttt{INIT} & 374 & 382 & 1.642 \\ 
                            ...
                            & \texttt{AUTH} & 4845 & 4831 & 1.262 \\ 
        \hline
        \multirow{3}{*}{A5} & \texttt{INIT} & 349 & 402 & 0.891 \\ 
                            & \texttt{INTE} & - & - & - \\
                            & \texttt{AUTH} & 646 & 587 & 1.688 \\ 
        \hline
        \multirow{3}{*}{B5} & \texttt{INIT} & 1514 & 1514 & 0.887 \\ 
                            & \texttt{INTE} & 350 & 358 & 1.672 \\
                            & \texttt{AUTH} & 12501 & 12471 & 1.266 \\ 
        \hline
        ...
        \hline
    \end{tabular} 
    \caption{Confronto tra le varie configurazioni} 
    \label{tab:result}
...
\begin{figure}[h!] 
    ...
    \begin{tikzpicture} 
        \begin{axis}[ 
            ...
            xtick=data,
            xlabel={},
            ylabel={Dimensione Pacchetti (Byte)}, % Etichetta asse Y 
            nodes near coords,
            ...
            \addplot coordinates {(Classica,745) (Quantum,2100) (Ibrida,2462)};  %coordinate per le configurazioni L1
            \addlegendentry{L1} % Dati per configurazioni post-quantum
            \addplot coordinates {(Classica,724) (Quantum,3004) (Ibrida,3266)}; 
            \addlegendentry{L3} % Dati per configurazioni post-quantum
            \addplot coordinates {(Classica,751) (Quantum,3736) (Ibrida,4280)}; 
            \addlegendentry{L5}
        \end{axis} 
    \end{tikzpicture} 
    \caption{Dimensione dei pacchetti in Byte per \texttt{INIT}}
...
\begin{figure}[h!] 
    ...
    \begin{tikzpicture} 
        \begin{axis}[ 
            ...
            \addplot coordinates {(Classica,1149) (Quantum,13228) (Ibrida,5214)};  %coordinate per le configurazioni L1
            \addlegendentry{L1} % Dati per configurazioni post-quantum
            \addplot coordinates {(Classica,1216) (Quantum,18390) (Ibrida,9676)}; 
            \addlegendentry{L3} % Dati per configurazioni post-quantum
            \addplot coordinates {(Classica,1233) (Quantum,24972) (Ibrida,9688)}; 
            \addlegendentry{L5}
        \end{axis} 
    \end{tikzpicture} 
